...
#ifndef materiais_hpp
#define materiais_hpp
...
GLfloat  redPlasticAmbT []={ 0.0 ,0.0 ,0.0 };
GLfloat  redPlasticDifT []={   0.5 ,0.0 ,0.0, 0.5 };
GLfloat  redPlasticSpecT []={ 0.7 ,0.6 ,0.6 };
GLint  redPlasticCoefT = 0.25 *128;
